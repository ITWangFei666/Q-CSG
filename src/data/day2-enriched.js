// Day 2 v0.5.0 — 7 步结构（学1a→学1b→学2a→学2b→探→验→结）
...
export const DAY2_ENRICHED_STEPS = [
  {
    id: 'd2_s1',
    type: 'reveal',
    title: '票面填写 — 为什么最常出错？（Day 2）',
    blocks: [
      {
        type: 'text',
        body: '根据国家能源局统计，电力事故中约30%与工作票填写不规范直接相关。最常见的死因不是"没办票"，而是"办了票但措施没写全"。一张填错的工作票，比没票更危险——因为它给人"很规范"的假象，但关键安全措施遗漏了，没人发现。'
      },
      {
        type: 'highlight',
        body: '真实案例：某供电局检修班办理了一张工作票，票面上安全措施只写了"断开开关"。作业人员按票操作，只断了开关没断刀闸。结果设备通过另一侧刀闸反送电，正在作业的人员触电重伤。如果票面上写了"断开开关及两侧刀闸"，这个事故完全可以避免。'
      },
      {
        type: 'comparison',
        left: { title: '❌ 常见错误票', body: '设备名称：城南线\n工作任务：处理缺陷\n安全措施：断开开关\n保留带电部位：无\n危险点：注意安全\n\n问题：5处致命错误，任何一个都可能导致事故' },
  ...
  },
  {
    id: 'd2_s1b',
    type: 'reveal',
    title: '工作票的五大块 + 填票四大铁律（Day 2）',
    blocks: [
      {
        type: 'text',
        body: '一张电气第一种工作票分为五大块：头部信息（谁在哪干什么）、安全措施（怎么保证不死人）、危险点分析（可能出什么事）、签发与许可（谁批准谁允许）、执行与终结（谁干活谁确认完工）。今天重点教中间三块：安全措施、危险点、签发许可。'
      },
      {
        type: 'text',
        body: '为什么填写规范这么难？因为很多人把填票当成"写作文"——差不多就行。但实际上，工作票是"操作指令书"——每一个字都对应现场的一个动作。写"断开开关"和写"断开101开关及1011、1012刀闸"的区别，可能就是一个生命的代价。'
      },
      {
        type: 'keypoints',
        title: '填票四大铁律',
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'highlight',
        body: '前 6 个错误都集中在"安全措施"这一块。为什么？因为很多人觉得"安全措施就是走个形式"，写得差不多就行。但实际上，安全措施是工作票最核心的部分——它直接决定了现场作业人员的生死。'
      }
    ],
    cta: '深入理解危险点',
    next: 'd2_s2b',
  ...
  },
  {
    id: 'd2_s2b',
    type: 'reveal',
    title: '危险点预控 — 写动作，不写口号（Day 2）',
    blocks: [
      {
        type: 'text',
        body: '第7个错误"写注意安全"尤其隐蔽。很多老师傅觉得"注意安全"是万金油，什么地方都能写。但"注意安全"不是措施，是口号。真正的预控措施必须包含三个要素：做什么（动作）、怎么做（方法）、做到什么标准（指标）。'
      },
      {
        type: 'comparison',
      ...
      {
        type: 'tip',
        body: '自查口诀：\n设备全称了吗？开关+刀闸都写了吗？\n接地线位置具体吗？带电部位真的无吗？\n危险点写动作了吗？人员都列全了吗？\n\n写完票后，把自己当成现场作业人员，按票面上的安全措施逐条执行——如果哪一条执行不了，这张票就不合格。'
      }
    ],
    cta: '审查一张问题票',
    next: 'd2_s3',
