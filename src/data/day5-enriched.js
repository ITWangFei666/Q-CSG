...
export const DAY5_ENRICHED_STEPS = [
  ...
  // ── 学2b：事故警示案例 1 ──
  {
    ...
    blocks: [
      {
        type: 'text',
        body: '某110kV线路检修结束，工作负责人和许可人未逐组核对接地线编号，口头确认”应该都拆了”。'
      },
      {
        type: 'highlight',
        body: '调度合闸送电时，两组接地线仍挂在#27杆和#32杆上——形成两条接地短路点。保护动作跳闸，全站失压。'
      },
      {
        type: 'keypoints',
        title: '根因与教训',
  ...
  // ── 学2b：事故警示案例 2 ──
  {
    ...
    blocks: [
      {
        type: 'text',
        body: '某电缆线路检修。工作负责人收工时清点人数——数了3遍都是9人（应到10人）。一名年轻工人还在电缆沟内整理工具，没人注意到他。'
      },
      {
        type: 'highlight',
        body: '幸运的是——送电前许可人发现电缆井盖没盖好，下去查看时发现了这名工人。一场悲剧在最后一秒被阻止。'
      },
      {
        type: 'keypoints',
        title: '根因与教训',
  ...
  // ── 学2b：事故警示案例 3 ──
  {
    id: 'd5_s4c',
    type: 'reveal',
    title: '标示牌未收回事故（Day 5）',
    blocks: [
      {
        type: 'text',
        body: '某输电线路检修结束。标示牌收回时发现少了一块”禁止合闸，有人工作”牌。工作负责人以为”风刮掉了”，没有进一步核实。'
      },
      {
        type: 'highlight',
        body: '实际上这块牌挂在另一条线路的杆塔上——那里还有一组人员在作业，但被遗漏在通信环节中。'
      },
      {
        type: 'keypoints',
        title: '根因与教训',
