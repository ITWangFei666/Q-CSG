// Day 2 加厚版 v2 — 5 步结构（学1→学2→探→验→结）
...
export const DAY2_ENRICHED_STEPS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'text',
        body: '第7个错误"写注意安全"尤其隐蔽。很多老师傅觉得"注意安全"是万金油，什么地方都能写。但"注意安全"不是措施，是口号。真正的预控措施必须包含三个要素：做什么（动作）、怎么做（方法）、做到什么标准（指标）。比如"触电：停电后验电、装设接地线、保持0.7m安全距离"——动作明确、方法具体、标准量化。'
      },
      {
        type: 'comparison',
